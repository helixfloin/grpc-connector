...
public final class GreeterGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "helixflo.example.grpc.Greeter";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<helixflo.example.grpc.HelloRequest,
      helixflo.example.grpc.HelloReply> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = helixflo.example.grpc.HelloRequest.class,
      responseType = helixflo.example.grpc.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<helixflo.example.grpc.HelloRequest,
      helixflo.example.grpc.HelloReply> getSayHelloMethod() {
    io.grpc.MethodDescriptor<helixflo.example.grpc.HelloRequest, helixflo.example.grpc.HelloReply> getSayHelloMethod;
    if ((getSayHelloMethod = GreeterGrpc.getSayHelloMethod) == null) {
      synchronized (GreeterGrpc.class) {
        if ((getSayHelloMethod = GreeterGrpc.getSayHelloMethod) == null) {
          GreeterGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<helixflo.example.grpc.HelloRequest, helixflo.example.grpc.HelloReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  helixflo.example.grpc.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  helixflo.example.grpc.HelloReply.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void sayHello(helixflo.example.grpc.HelloRequest request,
        io.grpc.stub.StreamObserver<helixflo.example.grpc.HelloReply> responseObserver) {
  ...
  public static final class GreeterStub
    ...
    /**
     */
    public void sayHello(helixflo.example.grpc.HelloRequest request,
        io.grpc.stub.StreamObserver<helixflo.example.grpc.HelloReply> responseObserver) {
  ...
  public static final class GreeterBlockingV2Stub
    ...
    /**
     */
    public helixflo.example.grpc.HelloReply sayHello(helixflo.example.grpc.HelloRequest request) throws io.grpc.StatusException {
  ...
  public static final class GreeterBlockingStub
    ...
    /**
     */
    public helixflo.example.grpc.HelloReply sayHello(helixflo.example.grpc.HelloRequest request) {
  ...
  public static final class GreeterFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<helixflo.example.grpc.HelloReply> sayHello(
        helixflo.example.grpc.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((helixflo.example.grpc.HelloRequest) request,
              (io.grpc.stub.StreamObserver<helixflo.example.grpc.HelloReply>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              helixflo.example.grpc.HelloRequest,
              helixflo.example.grpc.HelloReply>(
  ...
  private static abstract class GreeterBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return helixflo.example.grpc.GreeterProto.getDescriptor();
    }
